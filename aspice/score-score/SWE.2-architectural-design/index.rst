...
Structural View
===============
SOME/IP stacks as supplied by different vendors mostly are available as QM only.
...
.. note::
   ...
   For reference, this is the typical error enumeration:
...
--------------------------------
The E2E (End-to-End) state machine provides a summarized result
